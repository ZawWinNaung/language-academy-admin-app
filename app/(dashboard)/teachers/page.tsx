    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 glass-card p-4 rounded-2xl border border-slate-800/80">
        ...
        <div className="text-xs text-slate-400 font-medium">
          ...
          of <span className="text-white font-bold">{teachers.length}</span>{" "}
          Teachers
        </div>
      </div>
                ...
                {filteredTeachers.map((teacher) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <span className="px-2.5 py-1 rounded-md bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 font-mono text-[11px]">
